...
const DeviceListPage = ({ pageOptions }) => {
    ...
    const columns = [
        ...
        {
            title: translate.formatMessage(commonMessage.deviceName),
            dataIndex: 'name',
            width: 500,
            render: (name, record) => {
                ...
                return (
                    <div
                        ...
                        onClick={(e) => {
                            ...
                            navigate(`/device/${id}/brand?deviceName=${encodedName}`, {
    ...
    const searchFields = [
        {
            key: 'name',
            placeholder: translate.formatMessage(commonMessage.deviceName),
        },
        {
            key: 'status',
