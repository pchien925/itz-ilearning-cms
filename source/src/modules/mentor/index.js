    ...
    const { data, mixinFuncs, queryFilter, loading, pagination } = useListBase({
        ...
        override: (funcs) => {
            ...
            funcs.additionalActionColumnButtons = () => ({
                edit: (record) => {
                    const hasPerm = mixinFuncs.hasPermission([apiConfig.mentor.update.permissionCode]);
                    return (
                ...
                delete: (record) => {
                    ...
                    const hasPerm = mixinFuncs.hasPermission([apiConfig.mentor.delete.permissionCode]);
                    return (
